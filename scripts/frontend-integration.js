 ...
 * This file demonstrates how to integrate Wbtcbridge with a web frontend
 */

// For React/Vue/Angular applications
export class WbtcbridgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new WbtcbridgeClient(provider, contractAddress);
